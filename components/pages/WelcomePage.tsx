...
const WELCOME_STEPS = [
    {
        id: 1,
        title: "Bienvenue sur Grant App",
        description: "L'application qui vous aide à transformer vos habitudes financières pour de bon.",
        image: require("@/assets/images/icons/hello.png"),
    },
    {
        id: 2,
        title: "Suivez votre argent",
        description: "Gérez vos revenus et dépenses en toute simplicité pour ne plus jamais être à découvert.",
        image: require("@/assets/images/icons/coins.png"),
    },
    {
        id: 3,
        title: "Devenez un expert",
        description: "Apprenez les meilleures stratégies d'épargne et atteignez vos objectifs sereinement.",
    ...
    useEffect(() => {
        if (params.startStep) {
            ...
            if (!isNaN(stepIdx) && stepIdx >= 0 && stepIdx < WELCOME_STEPS.length) {
                ...
                setTimeout(() => {
                    scrollViewRef.current?.scrollTo({ x: stepIdx * width, animated: false });
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                ...
                <AuthButton
                    title={currentStep === WELCOME_STEPS.length - 1 ? "Commencer" : "Continuer"}
                    onPress={handleNext}
                />
...
const styles = StyleSheet.create({
    ...
    scrollView: { flex: 1 },
    slide: { width: width, alignItems: "center", justifyContent: "center", paddingHorizontal: 32, paddingTop: 52 },
    imageContainer: { width: width * 0.7, height: width * 0.7, marginBottom: 48, marginTop: -40, alignItems: 'center', justifyContent: 'center' },
    image: { width: "100%", height: "100%", resizeMode: "contain" },
    textContainer: { alignItems: "center" },
    title: { fontSize: 32, fontWeight: "900", color: colors.text, textAlign: "center", marginBottom: 16 },
    description: { fontSize: 18, fontWeight: "600", color: colors.text, textAlign: "center", opacity: 0.6, lineHeight: 26 },
    footer: { padding: 32, paddingBottom: 50 },
    bottomRow: { flexDirection: "row", alignItems: "center", justifyContent: "center", marginBottom: 32 },
    ...
    loginRow: { flexDirection: "row", justifyContent: "center", marginTop: 24, gap: 8 },
